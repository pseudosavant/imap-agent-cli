...
def build_parser() -> argparse.ArgumentParser:
    ...
    search.add_argument("--folder", help="search only this folder (default: INBOX, configurable with defaults.default_folder)")
    search.add_argument("--recursive", action="store_true", help="include child folders only when requested")
    search.add_argument("--all-folders", action="store_true", help="search all eligible folders only when requested (can be slow)")
